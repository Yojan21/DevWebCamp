<footer class="footer">
    <div class="footer_grid">
        <div class="footer_contenido">
            <a href="/">
                <h3 class="footer_logo">&#60;DevWebCamp/></h3>
            </a>
            <p class="footer_texto">DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva a cabo de forma presencial y en línea</p>
        </div>  
    ...
    <p class="footer_copy">
        DevWebCamp 
        <span 
            class="footer_copy-regular">- Todos los derechos reservados <?php echo date('Y'); ?>
        </span>
    </p>
